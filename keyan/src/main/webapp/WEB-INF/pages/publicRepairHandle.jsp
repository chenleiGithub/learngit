...
<tiles:insertDefinition name="defaultTemplate">
    <tiles:putAttribute name="body">
        ...
        <script src="static/js/publicRepairHandle.js"></script>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <div class="box-header">
                                ...
                                <div class="box-body">
                                    <div>
                                    	 <input type="button" id="addPublicRepairInfo" value="处理" class="btn btn-primary" name="add" />
                                    </div>
