...
<tiles:insertDefinition name="defaultTemplate">
    <tiles:putAttribute name="body">
        ...
        <script src="static/js/goodMoney.js"></script>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <div class="box-header">
                                ...
                                <div class="box-body">
                                    <div>
                                    	 <input type="button" id="addGoodMoneyInfo" value="添加" style="display:none" class="btn btn-primary" name="add" />
                                    	 <input type="button" id="updateGoodMoneyInfo" value="修改付款状态" style="display:none" class="btn btn-primary" name="update" />
                                         <input type="button" id="deleteList" value="删除" style="display:none" class="btn btn-danger" name="deleteList">
                                    </div>
                                    <table id="goodMoneyManageInfo" class="table table-bordered table-striped">
                                        <thead>
                                        <tr>
                                        	<th style="width:5%;">
                                            ...
                                            <th class="table-list-align-center" style="width: 20%">登记时间</th>
                                            <th class="table-list-align-center" style="width: 10%">物管费用</th>
                                            <th class="table-list-align-center" style="width: 15%">缴纳状态</th>
                                        </tr>
                                        </thead>
                                        <tbody></tbody>
                                    </table>
        ...
        <form class="form-horizontal" id="addGoodMoney" style="margin-left: 17%;display:none">
			...
			<div class="form-group">
				...
				<font style="color: red; font-size: 16px; font-weight: bolder;">*</font>
								&nbsp;物管费用</label>
				<div class="col-sm-8">
					<input type="text" class="form-control required number" id="allCost" name="allCost"
						placeholder="物管费用">
				</div>
			</div>
			<div class="form-group">
				<div class="col-sm-offset-5 col-sm-9">
					<button type="button" id="addGoodMoneyMessage" rangelength="2 40" class="btn btn-danger">保存</button>
				</div>
			</div>
		</form>
		
		<form class="form-horizontal" id="queryGoodMoney" style="margin-left: 17%;display:none">
			<div class="form-group">
				<label for="locationCode" class="col-sm-3 control-label">
								&nbsp;业主姓名</label>
				<div class="col-sm-8">
			...
			<div class="form-group">
				<label for="bureauAddress" class="col-sm-3 control-label">物管费用</label>
				<div class="col-sm-8">
