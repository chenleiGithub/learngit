var publicRepairHandle = {
	init : function() {
		// 绑定数据
		publicRepairHandle.message();
		//添加管理员
		publicRepairHandle.addPublicRepairManage();
		// 删除方法
		publicRepairHandle.deleteAssetManage();
		//全选功能
		publicRepairHandle.checkAll();
		$(".select2").select2();
							...
							columnDefs : [ {
								...
								render : function(data) {
									var context = {
										func : [ {
											"name" : "查看报修详情",
											"fn" : "publicRepairHandle.queryMessage("
													+ data.id +",'"+
													data.goodsName +"','"+
													data.strRepairDate +"','"+
												    data.position+"','"+
	...
	// 查询楼栋详情
	queryMessage:function(id,goodsName,strRepairDate,position,userName,reason,repairUser,repairMoney,repairResult){
